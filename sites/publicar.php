...
<div class="content-publicarevent">
                                ...
                                <div class="item-publicar">
                                 ...
                                 <input class="field-publicarevent" placeholder="Ej: Calle #246, Comuna, Ciudad" type="text" id="addresEvent" name="addresEvent"/> </br>
                                ...
                                <div class="item-publicar">
                                 ...
                                 <input class="field-publicarevent field-publicarevent-m " type="date" id="date-event" name="date-event"/>
                                </div>
                                
                                <div class="item-publicar">
                                 <div class="nombre-publicarevent">Hora (22:00)</div>
                                 <input  class="field-publicarevent field-publicarevent-s " type="text" id="hour-event" name="hour-event"/>
                                 <div class="dospuntos"></div>
                                 <input class="field-publicarevent field-publicarevent-s " type="text" id="minute-event" name="hour-event"/>
                                </div>
                                
                                <div class="item-publicar">
                                 <div class="nombre-publicarevent">URL FB</div>
                                 <input class="field-publicarevent" type="text" id="urlfacebook" name="url-face"/>
                                </div>
                                
                                <div class="item-publicar">
                                 <div class="nombre-publicarevent">URL Twitter</div>
                                 <input class="field-publicarevent" type="text" id="urltwitter" name="url-twitter"/>
                                </div>
