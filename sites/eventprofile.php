...
<div class="content-perfilevento">
    <div style='width:968px; height:400px;' id="content-mapaenvento">
            <div id='map_establecimientos' style='width:100%; height:100%;'></div>
        </div> 
                                  ...
                                  <?php 
                                   ...
                                   if($mio){?>
                                    ...
                                    <div id="dondeevent-prof" class="info-event-item"><?php  echo $eventfound['direccion'];?>
                                         <a href="#" id="vermapaEvento" class="link" >ver mapa</a>
