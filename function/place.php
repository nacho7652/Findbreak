<?php
  ...
  switch ($place){
      case 'inicio': $page_title = 'Nowsup - Now Whats Up ?';
                   $page_site = 'inicio';
                   $page_class = 'inicio';
                   $page_description = "Encuentra un quiebre a tu rutina";
                   break;
      //editar-usuario
      case 'editar-usuario': $page_title = 'Nowsup - Now Whats Up ?';
                   $page_site = 'editarusuario';
                   $page_class = 'publicar';
                   $page_description = "Encuentra un quiebre a tu rutina";
                   break;
      case 'editar-evento': $page_title = 'Nowsup - Now Whats Up ?';
                   $page_site = 'editarevento';
                   $page_class = 'publicar';
                   $page_description = "Encuentra un quiebre a tu rutina";
                   break;
     case 'publicar': $page_title = 'Nowsup - Now Whats Up ?';
                   $page_site = 'publicar';
                   $page_class = 'publicar';
                   $page_description = "Encuentra un quiebre a tu rutina";
                   break;
     case 'publicaciones': $page_title = 'Nowsup - Now Whats Up ?';
                   $page_site = 'publicaciones';
                   $page_class = 'publicaciones';
                   $page_description = "Encuentra un quiebre a tu rutina";
                   break;
     case 'login': $page_title = 'Nowsup - Now Whats Up ?';
                   $page_site = 'login';
                   $page_class = 'login';
                   $page_description = "Encuentra un quiebre a tu rutina";
                   break;
      case 'mapa': $page_title = 'Nowsup - Now Whats Up ?';
                   $page_site = 'cerca';
                   $page_class = 'cerca';
                   ...
                   break;
      case 'perfilest': 
                   $page_title = 'Nowsup - Now Whats Up ?';
                   $page_site = 'perfilest';
                   $page_class = 'perfilest';
                   $page_description = "Encuentra un quiebre a tu rutina";
                   break;
      case 'home': $page_title = 'Nowsup - Now Whats Up ?';
                   $page_site = 'home';
                   $page_class = 'home';
                   $page_description = "Encuentra un quiebre a tu rutina";
                   break;
    case 'userprofile': $page_title = 'Nowsup - Now Whats Up ?';
                   $page_site = 'userprofile';
                   $page_class = 'perfiluser';
                   $page_description = "Encuentra un quiebre a tu rutina";
                   break;
    case 'eventprofile': $page_title = 'Nowsup - Now Whats Up ?';
  ...
  $description = empty($_GET['description']) ? 'Nowsup - Now Whats Up ?' : $_GET['description'];
